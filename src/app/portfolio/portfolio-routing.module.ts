...
const appRoutes: Routes = [
	{ path: '', component: HomeComponent, data: { page : 'one', title: 'Guillaume Esnault | Portfolio', description: 'Guillaume Esnault : développeur full stack spécialisé Angular, passionné pour le web plus particulièrement par les technologies javascript, disponible dans les environs de Paris et partout dans le monde' } },
