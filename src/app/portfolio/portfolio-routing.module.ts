...
const appRoutes: Routes = [
	...
	{ path: 'a-propos', component: AboutComponent, data: { title: 'Guillaume Esnault | A propos', description: "Guillaume Esnault : Développeur autodidacte depuis plus de 4 ans, actuellement étudiant à l'école ESGI, développeur full stack" } }
];
